...
public class GameChallenge {
    ...
    printGameBoard(gameBoard);
        ...
        while (true){
            ...
            //while dont play over positions p1
            // while(player1Positions.contains(pos) || player2Positions.contains(player1Positions)){
            ...
            //while dont play over positions p2
            // while(player1Positions.contains(pos) || player1Positions.contains(player2Positions)){
            //     System.out.println("Position taken, enter correct position");
            //     pos = scan.nextInt();
            // }
